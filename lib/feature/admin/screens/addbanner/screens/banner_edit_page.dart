...
class EditBannerPage extends ConsumerStatefulWidget {
  ...
  const EditBannerPage({super.key,required this.bannerModel});

  @override
  ConsumerState<EditBannerPage> createState() => _AddBannerState();
}

class _AddBannerState extends ConsumerState<EditBannerPage> {
  ...
  @override
  void initState() {
    imageurl=widget.bannerModel.imageUrl;
              ...
              InkWell(
                onTap: () {
                  if(imageurl.isNotEmpty){
                    ref.read(bannerControllerProvider.notifier).updateBanner(image: imageurl, bannerModel: widget.bannerModel,);
